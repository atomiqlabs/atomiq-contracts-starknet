...
pub fn deploy() -> ERC20ABIDispatcher {
    ...
    IOwnableDispatcher{contract_address}.transfer_ownership('erc20 owner'.try_into().unwrap());
...
pub fn mint(erc20: ERC20ABIDispatcher, to: ContractAddress, amount: u256) {
    cheat_caller_address(erc20.contract_address, 'erc20 owner'.try_into().unwrap(), CheatSpan::TargetCalls(1));
