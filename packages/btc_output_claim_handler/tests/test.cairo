...
use btc_output_claim_handler::{Commitment, Witness};
...
pub fn deploy(header: StoredBlockHeader, relay_height: u32) -> (ContractAddress, IClaimHandlerDispatcher) {
    ...
    let contract = declare("BitcoinOutputClaimHandler").unwrap().contract_class();
