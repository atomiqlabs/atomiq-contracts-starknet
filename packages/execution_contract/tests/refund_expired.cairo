...
fn refund_and_assert(
    ...
    let result = context.contract.refund_expired(owner, salt, clear_all);
    if result.is_err() {
...
#[test]
#[should_panic(expected: 'refund_exp: Already processed')]
...
//Invalid refund, not expired yet, therefore not claimable yet for accounts other than owner
#[test]
#[should_panic(expected: 'refund_exp: Not expired yet')]
