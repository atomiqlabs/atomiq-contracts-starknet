...
#[generate_trait]
pub impl ByteArrayVarintReader of ByteArrayVarintReaderTrait {
    fn read_varint(self: @ByteArray, position: usize) -> (u64, usize) {
...
mod tests {
    ...
    fn test_manual() {
        ...
        assert_eq!(
            Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(0),
            (0xBB, 1)
        );
    ...
    fn test_random() {
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(31), (0x10aa46a3bf, 9));
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(47), (0x932608e058e7d3f, 9));

        let mut serialized_byte_array = array![0x0, 0x19d0ff033e596d10172900eb29f67584437f4f60e219867710, 0x19].span();
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(2), (0x2917106d593e03, 9));
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(18), (0x1f45077, 5));

        let mut serialized_byte_array = array![0x0, 0xfed77afa11f6be233f0fefe2, 0xc].span();
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(0), (0x11fa7ad7, 5));

        let mut serialized_byte_array = array![0x0, 0x020451ac02701fcf77ed2a6e, 0xc].span();
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(0), (0x2, 1));

        let mut serialized_byte_array = array![0x1, 0xd0ff34e1ff8901000000cf080b9bd9c68bbabea72a2896cd3dc4dbd80720e3, 0x5e, 0x1].span();
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(1), (0x189ffe134, 9));
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(10), (0xa742744, 5));
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(52), (0x347f148c5, 9));
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(9), (0x5896fae118e3b, 9));
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(12), (0x19419e29e02, 9));
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(23), (0x37f, 3));
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(89), (0x6aebf3e4, 5));

        let mut serialized_byte_array = array![0x0, 0x6cffd1027476a109000021c90e47314428, 0x11].span();
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(1), (0x9a1767402d1, 9));
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(49), (0x4eb3f, 5));
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(3), (0x1d201, 5));
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(2), (0x2ab50b230842345, 9));
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(32), (0x1a000, 5));
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(66), (0x1df5387469f0, 9));
        ...
        assert_eq!(Serde::<ByteArray>::deserialize(ref serialized_byte_array).unwrap().read_varint(16), (0x32f5e7d98bd8ffb, 9));
    }
