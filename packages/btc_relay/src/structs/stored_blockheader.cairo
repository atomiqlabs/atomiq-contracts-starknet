...
//All tests are generated by scripts/tests_unit/stored_blockheader.js
#[cfg(test)]
mod tests {
    use super::*;

    //Successful stored blockheader state updates, real data
    #[test]
    ...
    //Successful stored blockheader state updates during PoW difficulty retarget (start of new epoch), real data
    #[test]
    ...
    //Successful stored blockheader state updates during PoW difficulty retarget (start of new epoch), real data,
    // in this epoch the blocks were mined so fast that the PoW difficulty retarget reached its maximum value,
    // adjusting difficulty target 4x downwards (i.e. difficulty increased 4x)
    #[test]
    ...
    //Randomly generated successful stored blockheader updates
    #[test]
    ...
    //Randomly generated successful stored blockheader updates on PoW retarget (epoch end)
    #[test]
    ...
    //Randomly generated stored blockheader state updates during PoW difficulty retarget (start of new epoch),
    // in this epoch the blocks were mined so fast that the PoW difficulty retarget reached its maximum value,
    // adjusting difficulty target 4x downwards (i.e. difficulty increased 4x)
    #[test]
    ...
    //Randomly generated stored blockheader state updates during PoW difficulty retarget (start of new epoch),
    // in this epoch the blocks were mined very slow, so that the PoW difficulty retarget reached its minimum value,
    // adjusting difficulty target 4x upwards (i.e. difficulty decreased 4x)
    #[test]
    ...
    //Randomly generated valid stored blockheader updates with only last 6 blocks having the timestamp smaller than the current block
    #[test]
    ...
    //Randomly generated stored blockheader update mined with lower difficulty target
    #[test]
    ...
    //Randomly generated stored blockheader update with the added block having invalid nbits
    #[test]
    ...
    //Randomly generated stored blockheader update with the added block having invalid nbits during difficulty adjustment (epoch end)
    #[test]
    ...
    //Randomly generated stored blockheader update with the added block not having proper previous blockhash
    #[test]
    ...
    //Randomly generated stored blockheader update with the added block not having a timestamp larger than median of the last 11 blocks
    #[test]
