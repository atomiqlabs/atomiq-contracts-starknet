...
if(!fs.existsSync("./tests/data/fork_chain_chainwork")) fs.mkdirSync("./tests/data/fork_chain_chainwork");
...
fs.writeFileSync("./tests/data/fork_chain_chainwork.cairo", "pub mod fork_chain;\npub mod main_chain;\n");
