...
const {toCairoBlockheader, hex256bitReverseToU32Arr} = require("../utils/cairo_structs");
...
function getBlockheaderHashAssertion(blockheader) {
    return "//Blockheight: "+blockheader.height+"\n" +
        ...
        "assert_eq!(blockheader.dbl_sha256_hash(), "+hex256bitReverseToU32Arr(blockheader.hash)+");\n";
}
